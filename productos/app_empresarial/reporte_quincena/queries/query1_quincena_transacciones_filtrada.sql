/*
Version de query1 enfocada en transacciones y rango parametrizable desde Python.
Parametros: :fecha_inicio, :fecha_fin_exclusiva
*/
...
AND Fecha < :fecha_fin_exclusiva
AND (
    LOWER(LTRIM(RTRIM(Modulo))) IN (
        'trx journal',
        'ach',
        'ach qr',
        'dividelo todo',
    ...
    OR LTRIM(RTRIM(ISNULL([Operación], ''))) = ''
)
