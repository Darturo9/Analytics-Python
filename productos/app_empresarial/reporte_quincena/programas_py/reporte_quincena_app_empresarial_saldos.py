"""
Reporte quincenal configurable de saldos - App Empresarial.
...
4) Filtro a modulos objetivo
5) Perfil financiero: saldo de cierre, saldo promedio, clientes con saldo y top deptos
...
def imprimir_resumen_financiero(
    ...
    if total_clientes == 0:
        print("\nPerfil financiero de clientes matched (modulos objetivo):")
    ...
    print("\n" + "=" * 92)
    print("PERFIL FINANCIERO - CLIENTES MATCHED (MODULOS OBJETIVO)")
    print("=" * 92)
    ...
    print(f"\nTop {CONFIG_TOP_DEPTOS} deptos por clientes (matched modulos objetivo):")
    print(
...
def main() -> None:
    try:
        ...
        df_match_obj = df_match[df_match["modulo_regla"].isin(MODULOS_OBJETIVO)].copy()
