...
FROM (
	...
	WHERE 
		(
		dw_bel_IBSTTRA_VIEW.dw_fecha_trx >= '2025-01-01'
...
FROM (
	...
	FROM (
		...
		FROM 
			DWHBI..WF_Incidente
		WHERE 
			CAST(Fecha_hora_entrada AS DATE) >= '2025-01-01'
			--BETWEEN '02/01/2025 00:00:00' AND '02/28/2025 23:59:59' 
			AND Proceso IN
				(
...
---- TRX JOURNAL
	...
	WHERE 
	(
		dw_BEL_IBJOUR.dw_fecha_journal >= '2025-01-01'
...
UNION ALL
	...
	WHERE 
		(
		dw_bel_IBHISPLA.dw_fecha_sistema >= '2025-01-01'
...
UNION ALL
	...
	WHERE 
		(
		DW_DEP_DPMOVM_VIEW.dw_fecha_operacion >= '2025-01-01'
...
UNION ALL
	...
	WHERE 
		(
		dw_bel_IBHLTP.dw_fecha_aplicado >= '2025-01-01'
...
------------------ Multipagos ------------------
	...
	WHERE
		(
		DW_MUL_SPPADAT.DW_FECHA_OPERACION_SP >= '2025-01-01'
...
UNION ALL
	...
	WHERE
		DW_BEL_IBLOGDTO.DW_FECHA >= '2025-01-01'
...
UNION ALL
	...
	WHERE
		(
		DW_BEL_IBLOGBDT.DW_FECHA >= '2025-01-01'
...
UNION ALL
	...
	WHERE   
		DW_BEL_IBLGLXUS.DW_FECHA_CONTROL >= '2025-01-01'
...
UNION ALL
	...
	WHERE   
		DW_BEL_IBLGAPPY.DW_FECHA_CONTROL >= '2025-01-01'
