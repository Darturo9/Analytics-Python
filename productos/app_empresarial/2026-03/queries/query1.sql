...
FROM (
	...
	WHERE 
		(
		dw_bel_IBSTTRA_VIEW.dw_fecha_trx >= '2025-12-01'
...
---- TRX JOURNAL
	...
	WHERE 
	(
		dw_BEL_IBJOUR.dw_fecha_journal >= '2025-12-01'
...
UNION ALL
	...
	WHERE 
		(
		dw_bel_IBHISPLA.dw_fecha_sistema >= '2025-12-01'
...
UNION ALL
	...
	WHERE 
		(
		DW_DEP_DPMOVM_VIEW.dw_fecha_operacion >= '2025-12-01'
...
UNION ALL
	...
	WHERE 
		(
		dw_bel_IBHLTP.dw_fecha_aplicado >= '2025-12-01'
...
------------------ Multipagos ------------------
	...
	WHERE
		(
		DW_MUL_SPPADAT.DW_FECHA_OPERACION_SP >= '2025-12-01'
...
UNION ALL
	...
	WHERE
		DW_BEL_IBLOGDTO.DW_FECHA >= '2025-12-01'
...
UNION ALL
	...
	WHERE
		(
		DW_BEL_IBLOGBDT.DW_FECHA >= '2025-12-01'
...
UNION ALL
	...
	WHERE   
		DW_BEL_IBLGLXUS.DW_FECHA_CONTROL >= '2025-12-01'
...
UNION ALL
	...
	WHERE   
		DW_BEL_IBLGAPPY.DW_FECHA_CONTROL >= '2025-12-01'
		
	) TransaccionesBase
	WHERE
		TransaccionesBase.Canal in ( 'App nueva','AP','APP')
		AND TransaccionesBase.Fecha >= '2025-12-01'
) Transacciones
