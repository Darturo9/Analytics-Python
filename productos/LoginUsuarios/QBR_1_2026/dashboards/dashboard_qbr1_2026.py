"""
dashboard_qbr1_2026.py
----------------------
Dashboard Login Usuarios - Q1 2026.

Universo:
- Clientes de la base CIF69.
...
def construir_layout(df_logins: pd.DataFrame) -> html.Div:
    ...
    return html.Div(
        ...
        children=[
            html.H2("Login Usuarios - Q1 2026", style={"color": COLORES["azul_experto"], "marginBottom": "6px"}),
            html.P(
                "Medicion de logins para clientes de CIF69 durante enero, febrero y marzo 2026.",
...
def main() -> None:
    ...
    print("Dashboard corriendo en http://127.0.0.1:8065")
    app.run(debug=True, use_reloader=False, port=8065)
