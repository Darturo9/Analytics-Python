...
# Query separada para el total: deduplica clientes únicos entre campañas
SQL_TOTAL = """
WITH campanas_abril AS (
    SELECT DISTINCT
        RIGHT(
...
def main() -> None:
    print("\nÁrbol Sin Login — Contactados, Login y Cambio de Contraseña por Campaña")
    ...
    try:
        ...
        print("\n" + "=" * 58)
        print("  TOTAL (clientes únicos deduplicados entre campañas)")
        print("=" * 58)
