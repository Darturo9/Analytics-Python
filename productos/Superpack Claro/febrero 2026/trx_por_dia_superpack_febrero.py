...
QUERY_PATH = Path(__file__).resolve().parent / "queries" / "trx_por_dia_superpack_febrero_2026.sql"


def imprimir_resultados(df) -> None:
    if df.empty:
        print("Sin resultados para SUPERPACK-CLARO en febrero 2026.")
        return

    print("\n" + "=" * 50)
    print("  SUPERPACK-CLARO - TRX POR DIA - FEBRERO 2026")
    print("=" * 50)
...
def main() -> None:
    try:
        print("Consultando transacciones por dia SUPERPACK-CLARO febrero 2026...")
