/*
Compradores de Superpack Claro >= L.120 - Abril 2026 (universo completo)

Universo: todos los compradores de Superpack en abril 2026, sin filtrar
...
compradores_efectivos AS (
    -- clientes con al menos 1 compra no revertida
    SELECT DISTINCT padded_codigo_cliente
    FROM trx_superpack
    WHERE es_reversa = 'N'
),
compradores_120 AS (
    -- clientes con al menos 1 compra no revertida >= L.120
    SELECT DISTINCT padded_codigo_cliente
    FROM trx_superpack
    WHERE es_reversa = 'N'
