...
def imprimir_resumen(detalle: pd.DataFrame, compras: pd.DataFrame) -> None:
    ...
    print(f"Universo total compradores abril (no solo lista): {total_clientes_compradores_universo:,}")
    print(f"Universo total transacciones abril: {total_tx_universo:,}")
    print(f"Universo monto total abril: {monto_total_universo:,.2f}")
    print("----------------------------------------------------")
