    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    dcc.Graph(id="g-suma-saldo-promedio", style={"width": "100%"}),
                    dcc.Graph(id="g-suma-saldo-cierre", style={"width": "100%"}),
                    dcc.Graph(id="g-cuentas-analizadas", style={"width": "100%"}),
                    dcc.Graph(id="g-promedio-saldo-cierre", style={"width": "100%"}),
                    dcc.Graph(id="g-promedio-saldo-promedio", style={"width": "100%"}),
                ],
            ),
        ],
    )
