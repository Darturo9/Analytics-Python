"""
dashboard_q1_2026.py
--------------------
Dashboard Creacion de Usuario SV (QBR 1 2026)
Ejecutar desde la raiz del proyecto:

    python3 productos/creacion_usuario_sv/QBR_1_2026/dashboards/dashboard_q1_2026.py
"""
...
print(f"Cargando datos de creacion de usuario SV Q1 2026 (conversion) en {DB_NAME_DASHBOARD}...")
df_conversion = run_query_file_hsv("productos/creacion_usuario_sv/QBR_1_2026/sql/conversion_q1_2026.sql")
print(f"  {len(df_conversion)} registros en conversión")

print("Cargando datos de campañas RTM...")
df_rtm = run_query_file_hsv("productos/creacion_usuario_sv/QBR_1_2026/sql/comunicacionesRTM_q1_2026.sql")
...
# Seguridad adicional: limitar dashboard a Q1 2026.
df = df[(df["anio"] == QBR_YEAR) & (df["mes"].isin(QBR_MONTHS))].copy()
...
def actualizar_dashboard(anio, mes, origen):
    if anio is None or mes is None:
        ...
        return (
            "Creacion de Usuario SV - QBR 1 2026",
            "0",
            "0",
            "0",
            "0",
    ...
    titulo = f"Creacion de Usuario SV - QBR 1 2026 | {MESES_ES[int(mes)]} {int(anio)}{sufijo}"
...
if __name__ == "__main__":
    print("Dashboard corriendo en http://127.0.0.1:8054")
